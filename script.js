//Criando a calsse da calculadora
class Caculator{
    constructor(){
        // Aqui é a propriedade que receberá os valores digitados
        this.displayValue = " ";
    }
    //Este método adiciona os valores á propriedade displayValue
    //Permitindo que o usuário veja os caracteres/valores na tela
    appendToDisplay(value) {
        this.displayValue += value;
        // Chamamos o método updateDisplay dentro do método appendToDisplay para que 
        // quando o usuário digitar alguma tecla da calculadora o valor que foi
        // alguma tecla da calculadora o valor que foi armazenado na propriedade displayValue seja exibida na tela.
        this.updateDisplay();
    }
    ...
    // O método try catch executa o cálculo da expressão matemática contida em displayValue. Esse
    // método utiliza a função eval() para avaliar a expressão e, se for bem sucedida, atualiza o displayValue
...
//Criando o objeto ou instanciando o objeto
//Objeto chamado calc
